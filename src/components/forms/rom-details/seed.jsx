                    ...
                    <Grid container spacing={2} alignItems="center">
                        <Grid item>
                            <InputGroup>
                                ...
                                <FormInput value={this.state.seedValue} onChange={(e) => this.handleSeedChange(e.target.value)} type="text" />
                            </InputGroup>
                        </Grid>
                        <Grid item xs>
                            <Tooltip title="Randomize Seed">
                                <Button variant="contained" color="primary" onClick={this.handleRandomizeSeed}><RedoIcon /></Button>
                            </Tooltip>
                        </Grid>
                    </Grid>
                </Fragment>
